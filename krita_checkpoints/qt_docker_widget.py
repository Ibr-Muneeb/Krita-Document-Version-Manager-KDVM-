...
from . import icons_rc  # noqa: F401 (imported for its Qt resource side-effect)
...
class VersionManager(QtWidgets.QWidget, qt_docker_widget_ui.Ui_Form):
    ...
    def toggle_log_view(self):
        ...
        self.is_logview_visible = not self.is_logview_visible
        self.debug_console.setVisible(self.is_logview_visible)
    ...
    def add_checkpoint(self, s):
        ...
        try:
            self.history_widget.add_checkpoint(
                msg=self.checkpoint_msg.toPlainText(),
